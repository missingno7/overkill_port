...
POSTMOVE_CONTACT_VIEW_X = 0x237E
POSTMOVE_CONTACT_Y_GUARD = 0x2380
VIEW_WINDOW_SIDE_SELECTOR = 0x2384
FINAL_BOSS_CONTACT_MODE = 0xA8C2
...
TILE_COLLISION_DEBUG_FLAG = 0x98C0
TILE_COLLISION_DEBUG_CODE = 0xBEFF
TILE_COLLISION_DEBUG_BLOCKED_CODE = 0x0E
TILE_COLLISION_BEDC_GATE = 0xBEDC
