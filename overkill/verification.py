...
DEFAULT_STOPS: dict[Addr, HookStop] = {
    ...
    (0x1010, 0xD390): HookStop.after_step("fixed_ips", ips=(0xD390, 0xD39A)),
    (0x1010, 0xD434): HookStop.after_step("fixed_ips", ips=(0xD434, 0xD43B, 0xD445)),
    (0x1010, 0xD445): HookStop.after_step("near_ret_or_fixed_ip", ip=0xD445),
