...
function for 1010:5DB2 (DOS_RE 2.0 stage 2).  DO NOT hand-edit; regenerate.
...
_LOCAL = {0x5DB2: 0, 0x5DC7: 1, 0x5DC9: 2, 0x5DCB: 3, 0x5DD3: 4, 0x5DD9: 5, 0x5DE2: 6, 0x5DE4: 7, 0x5DE6: 8, 0x5DED: 9, 0x5DF2: 10, 0x5DFD: 11, 0x5E14: 12}


def func_1010_5db2(mem, plat, *, _base=0, _df=0, _flags_in=2, bp=0, cx=0, di=0, ds=0, dx=0, es=0, si=0, sp=0, ss=0):
    _cost = 0
    ...
    while True:
        _iters += 1
        if _iters > 20000000:
            raise RuntimeError('CPUless dispatch spin in 1010:5DB2 (block %d, cost %d): loop exceeded 20000000 iterations -- an unbounded wait (interrupt-updated flag, or a wrong port after a state divergence)' % (bb, _cost))
        if bb == 0:  # 1010:5DB2
