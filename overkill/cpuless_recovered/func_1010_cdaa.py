...
function for 1010:CDAA (DOS_RE 2.0 stage 2).  DO NOT hand-edit; regenerate.
...
_LOCAL = {0xCC58: 0, 0xCC76: 1, 0xCC7F: 2, 0xCDAA: 3, 0xCDC4: 4, 0xCDC8: 5, 0xCDCA: 6, 0xCE02: 7, 0xCE0E: 8, 0xCE10: 9, 0xCE13: 10, 0xCE1F: 11, 0xCE21: 12, 0xCE24: 13, 0xCE2B: 14, 0xCE31: 15, 0xCE34: 16, 0xCE36: 17, 0xCE39: 18}


def func_1010_cdaa(mem, plat, *, _base=0, _df=0, _flags_in=2, bp=0, bx=0, cx=0, di=0, ds=0, dx=0, es=0, si=0, sp=0, ss=0):
    _cost = 0
    ...
    while True:
        _iters += 1
        if _iters > _ITER_CAP:
            raise RuntimeError('CPUless dispatch spin in 1010:CDAA (block %d, cost %d): loop exceeded 20000000 iterations -- an unbounded wait (interrupt-updated flag, or a wrong port after a state divergence)' % (bb, _cost))
        if bb == 0:  # 1010:CC58
            sp = (sp - 2) & 0xFFFF
            mem.ww(ss, sp, cx)
