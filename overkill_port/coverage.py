...
class OverkillCoverageClassifier:
    ...
    _asset_re = re.compile(
        r"(asset|codec|packed|lz|rle|decoder|encode|decode|expand|startup|loading|load|overlay|checksum|input_byte|output_byte)",
        re.IGNORECASE,
    )
    ...
    LAYER_SPRITE_ADDRS: set[Addr] = {
        ...
        (0x1010, 0xA927), (0x1010, 0xA936), (0x1010, 0xA939), (0x1010, 0xA93A),
    }
    TANDY_RENDER_ADDRS: set[Addr] = {
        (0x1010, 0x2E6E), (0x1010, 0x2ECB), (0x1010, 0x2F40),
        (0x1010, 0x0FA3), (0x1010, 0x0FE4),
        (0x1010, 0x2F81), (0x1010, 0x2FB6), (0x1010, 0x306F),
        (0x1010, 0x3153), (0x1010, 0x519A), (0x1010, 0x5F06),
        (0x1010, 0x3354), (0x1010, 0x33AF),
        (0x1010, 0x33B2), (0x1010, 0x33DD), (0x1010, 0x34AD),
    ...
    CGA_RENDER_ADDRS: set[Addr] = {
        (0x1010, 0x447B), (0x1010, 0x450C), (0x1010, 0x4511),
        (0x1010, 0x4537), (0x1010, 0x45CB), (0x1010, 0x45F6),
        (0x1010, 0x477E), (0x1010, 0x4D15), (0x1010, 0x4D6F),
    }
    ...
    GAMEPLAY_OBJECT_ADDRS: set[Addr] = {
        (0x1010, 0x017E), (0x1010, 0x75A6), (0x1010, 0xB73E),
        (0x1010, 0xAA01), (0x1010, 0xAA04), (0x1010, 0xAA05),
        (0x1010, 0xAA10), (0x1010, 0xAA1F), (0x1010, 0xAA22), (0x1010, 0xAA23), (0x1010, 0xAA25),
        (0x1010, 0xAA2B), (0x1010, 0xEFAE),
    }
    ...
    COLLISION_ADDRS: set[Addr] = {
        ...
        (0x1010, 0x9E69), (0x1010, 0x9E98), (0x1010, 0xBCCB),
        (0x1010, 0xBC4B), (0x1010, 0xBDE3), (0x1010, 0xBDD0),
    }
    ...
    ASSET_CODEC_ADDRS: set[Addr] = {
        ...
        (0x1010, 0x0615), (0x1010, 0x0624), (0x1010, 0x33AF),
        (0x1010, 0x33B2), (0x1010, 0x33DD), (0x1010, 0x36A2),
        (0x1010, 0x45CB), (0x1010, 0x45F6), (0x1010, 0x60C5),
        (0x1010, 0xECF2), (0x1010, 0xED7A), (0x1010, 0xED97),
        (0x1010, 0xEDE9), (0x1F8F, 0x0960),
    }
