...
The implementation bodies live in :mod:`overkill_port.games.overkill.asset_codecs`
...
overkill_file_checksum_loop = overkill_file_checksum_loop_c916
...
# Backward-compatible import alias for older tests/scripts.
overkill_packed_read_byte = overkill_packed_read_byte_0624
...
# Backward-compatible import alias for older tests/scripts.
overkill_packed_read_word = overkill_packed_read_word_le_0615
