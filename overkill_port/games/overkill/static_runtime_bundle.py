...
from ...memory import CPU_MEM_SIZE, linear
from ...runtime import Runtime, create_runtime
from ...snapshot import run_until, write_snapshot
...
def materialize_static_runtime_bundle(
    ...
    *,
    ...
    rt = create_runtime(exe_path, game_root=game_root, command_tail=build_command_tail(video, sound))
