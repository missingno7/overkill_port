...
2. Use `artifacts/snapshot_after_bootstrap_100k/memory_1mb.bin` as the authoritative binary image for addresses that differ from `assets/OVERKILL.UNLZEXE.EXE`.
