...
- Every accepted live-byte body must be named in `games/overkill/runtime_code.py`.
...
`overkill_port/games/overkill/runtime_code.py` owns the manifest:
...
- `1010:5E42 runtime_patched_object_steer_5e42`
  ...
  - static target:
    `overkill_port.games.overkill.gameplay.object_runtime.run_runtime_patched_object_steer_5e42`
